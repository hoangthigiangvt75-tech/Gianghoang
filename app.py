...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Thị Giang - Trường  Tiểu học Vĩnh thành - ĐT: 0913784075 343</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - hoàng Thị Giang - Trường  Tiểu học Vĩnh Thành - ĐT: 0913784075 343</div>", unsafe_allow_html=True)
